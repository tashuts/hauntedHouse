...
def start_story():
    ...
    while True:
        user_choice = input("What would you like to do? You can 'enter' the house or 'leave'. Type your choice: ").lower()
...
def upstairs():
    ...
    while True:
        user_choice = input("Do you 'talk' to the ghost, 'run' out of the room, or 'investigate' the mirror on the wall? Type your choice: ").lower()
...
def explore_hallway():
    ...
    while True:
        user_choice = input("Do you want to 'enter' the room with the growl or 'turn back' and leave the house? Type your choice: ").lower()
...
def open_strange_door():
    ...
    while True:
        user_choice = input("Do you 'talk' to the witch, 'run' away, or 'inspect' the cauldron? Type your choice: ").lower()
...
def vampire_encounter():
    ...
    while True:
        user_choice = input("Do you 'join' the vampire, 'fight' him, or 'run' away? Type your choice: ").lower()
        ...
        if user_choice == "stop":
            ...
            print(f"\n{outcome}")
            choices_made.append("Vampire: " + outcome)
            break
...
def werewolf_encounter():
    ...
    while True:
        user_choice = input("Do you 'fight' the werewolf, 'run' for the door, or 'try' to reason with it? Type your choice: ").lower()
        ...
        if user_choice == "stop":
            ...
            print(f"\n{outcome}")
            choices_made.append("Werewolf: " + outcome)
            break
        elif user_choice == "run":
...
def underground_lair():
    ...
    while True:
        user_choice = input("Do you 'fight' them all, 'try to escape' the lair, or 'join' their secret society? Type your choice: ").lower()
...
def leave_house():
    ...
    print("\n--- Game Summary ---")
    print("Choices made during the game:")
